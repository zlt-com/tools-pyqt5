...
class Ui_MainPage(object):
    def setupUi(self, MainPage):
        ...
        self.tab3_text_all_file = QtWidgets.QTextEdit(self.tab_scan_file_list)
        ...
        self.tab3_text_parser_file = QtWidgets.QTextEdit(self.tab_parser_keyword)
        self.tab3_text_parser_file.setObjectName("tab3_text_parser_file")
        self.gridLayout_7.addWidget(self.tab3_text_parser_file, 0, 0, 1, 1)
