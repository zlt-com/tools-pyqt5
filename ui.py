...
class Ui_MainPage(object):
    def setupUi(self, MainPage):
        ...
        self.tab3_text_keywords = QtWidgets.QTextEdit(self.tab_3)
        ...
        self.tab3_text_all_file = QtWidgets.QTextEdit(self.tab_4)
        self.tab3_text_all_file.setObjectName("tab3_text_all_file")
        self.gridLayout_5.addWidget(self.tab3_text_all_file, 0, 0, 1, 1)
        self.tabWidget_2.addTab(self.tab_4, "")
        self.tab_5 = QtWidgets.QWidget()
        self.tab_5.setObjectName("tab_5")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.tab_5)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.tab3_text_match_file = QtWidgets.QTextEdit(self.tab_5)
        self.tab3_text_match_file.setObjectName("tab3_text_match_file")
        self.gridLayout_7.addWidget(self.tab3_text_match_file, 0, 0, 1, 1)
        self.tabWidget_2.addTab(self.tab_5, "")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.tabWidget_2)
    ...
    def retranslateUi(self, MainPage):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_4), _translate("MainPage", "扫描到的文件"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), _translate("MainPage", "与关键字匹配的文件"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainPage", "关键字扫描"))
